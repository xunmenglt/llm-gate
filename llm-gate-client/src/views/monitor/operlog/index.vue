  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="businessType">
        ...
        >
          <el-option
            v-for="dict in dict.sys_oper_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
<script>
import { listOperlog, delOperlog, cleanOperlog, exportOperLogs } from "@/api/monitor/operlog";
...
export default {
  ...
  methods: {
    ...
    typeFormat(row, column) {
      return this.selectDictLabel(this.dict.sys_oper_type, row.businessType);
    },
    /** 搜索按钮操作 */
    handleQuery() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      exportOperLogs(this.queryParams)
    }
  }
};
</script>
