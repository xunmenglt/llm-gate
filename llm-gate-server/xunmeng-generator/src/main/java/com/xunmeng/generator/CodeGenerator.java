...
public class CodeGenerator {
    ...
    private static String db_url="jdbc:mysql://localhost:3306/llmgate?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    private static String db_dirver="com.mysql.cj.jdbc.Driver";
    private static String db_user="root";
    private static String db_password="codura";
    private static String parentPage="com.xunmeng.system";
    private static String table_prefix="g_";
    /**
     * <p>
     * 读取控制台内容
     * </p>
